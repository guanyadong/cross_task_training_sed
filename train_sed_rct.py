...
from local.sed_trainer_rct import SEDTask4_2021

from local.resample_folder import resample_folder
from local.utils import generate_tsv_wav_durations, calculate_macs
...
def single_run(
    ...
    desed_training.load_state_dict(test_state_dict, strict=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--conf_file",
        default="./confs/sed_conf.yaml",
        help="The configuration file with all the experiment parameters.",
    )
    parser.add_argument(
        "--log_dir",
        default="./exp/cross_task_training",
    ...
    parser.add_argument(
        ...
        default='./exp/cross_task_training/version_9/epoch=187-step=44367.ckpt',
